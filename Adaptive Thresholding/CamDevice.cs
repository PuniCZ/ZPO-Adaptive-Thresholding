...
namespace AdaptiveThresholding
{
    public class CamDevice
    {
        ...
        public void ShowWindow(System.Windows.Window windowsControl/*   global::System.Windows.Forms.Control windowsControl*/)
        {
            Init((int)windowsControl.Height, (int)windowsControl.Width, new WindowInteropHelper(windowsControl).Handle.ToInt32());                        
        }
